...
This document is dedicated to the desctiption and purpose of the **Papers Parse** tool that is dedicated to the SciHub papers parsing, transofrming and analyzing of those with respect to the affilations and acknowledgement. 
...
SciHub parser based on *@allenai*'s [science parse](https://github.com/allenai/science-parse)ct)

## Contact info <a name="contact-info"></a>
